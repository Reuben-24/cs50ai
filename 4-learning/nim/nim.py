...
class NimAI:
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        self.q[(tuple(state), tuple(action))] = updated_q_value
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if not epsilon: # If epsilon is false return best_action
            return best_action
        
        # Otherwise, epsilon is true, return best action with probability 1 - epsilon
